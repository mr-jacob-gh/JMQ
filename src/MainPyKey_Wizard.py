...
def loaddefaultspells(xpac):
    if xpac == 'kunark':
        ...
        memspell('ro', spells.get('ro').get('slot'))
        memspell('wl', spells.get('wl').get('slot'))
        memspell('ic', spells.get('ic').get('slot'))
        memspell('feerrott', spells.get('feerrott').get('slot'))
...
if __name__ == "__main__":
    log_filepath = ("C:/Users/Public/Daybreak Game Company/Installed Games/EverQuest/Logs/eqlog_Melzwiz_teek.txt")
    ...
    spells = {
        ...
        'wl': {'slot': 2, 'casttime': 10.0, 'recasttime': 6.0},
        ...
        'ro': {'slot': 1, 'casttime': 10.0, 'recasttime': 6.0},
        ...
        'gfay': {'slot': 5, 'casttime': 10.0, 'recasttime': 6.0},
        'ggfay': {'slot': 8, 'casttime': 16.0, 'recasttime': 10.0},
    }

    spell_ids = {'cl': '1372',
                 'cs': '2025', 'gd': '2023',
                 'ic': '2022', 'wl': '2024', 'dl': '1339', 'feerrott': '1375',
                 'nk': '1338', 'lava': '1371', 'ro': '1373',
                 'sfg': '1374', 'toxx': '1337', 'sf': '1738', 'ej': '1739', 'ba': '35', 'invis': '42',
                 'dawn': '24772', 'grim': '25697',
                 'nexus': '25898', 'twi': '25905', 'soe': '2517', 'cos': '2519',
                 'gic': '1434',
                 'ggd': '1438', 'gwl': '1398', 'gcs': '1440', 'gkarana': '562', 'gtoxx': '561',
                 'gsfg': '568', 'gcl': '566', 'glava': '564', 'gro': '567', 'gfear': '565',
                 'gmisty': '558', 'gfay': '1336', 'ggfay': '563'}

    master_phrase_map = {'cl': 'cl', 'levi': 'lev', 'lev': 'lev',
                         'cs': 'cs',
                         'gd': 'gd', 'ic': 'ic', 'wl': 'wl', 'dl': 'dl', 'bb': 'bb', 'feerrott': 'feerrott',
                         'nk': 'nk', 'lava': 'lava', 'misty': 'misty', 'ro': 'ro', 'steamfont': 'steamfont',
                         'sfg': 'sfg', 'toxx': 'toxx', 'spirit of wolf': 'sow', 'ec': 'cl', 'commons': 'cl', 'commonlands': 'cl',
                         'common lands': 'cl', 'east commons': 'cl', 'levitate': 'lev', 'cobalt scar': 'cs',
                         'northk': 'nk', 'north karana': 'nk',
                         'karana': 'nk', 'lavastorm': 'lava', 'lava storm': 'lava',
                         ...
                         'camouflage': 'invis', 'superior camouflage': 'invis', 'fearrott': 'feerrott',
                         'ct': 'feerrott', 'dawn': 'dawn', 'dawnshroud': 'dawn',
    ...
    group_spells = ['ej', 'sf', 'ba', 'invis', 'gic', 'ggd', 'gwl', 'gcs', 'gkarana', 'gtoxx', 'gsfg', 'gcl',
                    'glava', 'gro', 'gfear', 'ggfay']
