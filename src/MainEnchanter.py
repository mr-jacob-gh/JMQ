...
def loaddefaultspells():
    memspell('kei', spells.get('kei').get('slot'))
...
if __name__ == "__main__":
    log_filepath = "C:/Users/Public/Daybreak Game Company/Installed Games/EverQuest/Logs/eqlog_Smelz_oakwynd.txt"
    ...
    #
    spells = {
        'kei': {'slot': 2, 'casttime': 5.0, 'recasttime': 1.5}
    }

    spell_ids = {'kei': '2570'}

    master_phrase_map = {'kei': 'kei', 'c3': 'kei'}
